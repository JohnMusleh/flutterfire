...
class StorageReference {
  ...
  /// Returns the [MethodChannelFirebaseStorage] service which created this reference.
  MethodChannelFirebaseStorage getStorage() {
  ...
  Future<String> getBucket() async {
    return await MethodChannelFirebaseStorage.channel
  ...
  Future<String> getPath() async {
    final String path = await MethodChannelFirebaseStorage.channel
  ...
  Future<Uint8List> getData(int maxSize) async {
    return await MethodChannelFirebaseStorage.channel.invokeMethod<Uint8List>(
  ...
  Future<dynamic> getDownloadURL() async {
    return await MethodChannelFirebaseStorage.channel.invokeMethod<dynamic>(
  ...
  Future<StorageMetadata> getMetadata() async {
    return StorageMetadata._fromMap(await MethodChannelFirebaseStorage.channel
